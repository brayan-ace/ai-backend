...
class StudyPlanChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(planTitle ?? 'Study Plan')),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(planTitle ?? 'Study Plan', style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 8),
              Text(planContext ?? 'No context available', textAlign: TextAlign.center),
            ],
          ),
        ),
      ),
...
/// Clean placeholder for StudyPlanChatScreen to ensure the app compiles.
class StudyPlanChatScreen extends StatelessWidget {
  final String? planId;
  final String? planTitle;
  final String? planContext;
...
/// Minimal, single-definition placeholder for StudyPlanChatScreen.
/// Keeps the original constructor (planId/planTitle/planContext) so
/// other code that references this screen continues to compile.
class StudyPlanChatScreen extends StatelessWidget {
  final String? planId;
  final String? planTitle;
  final String? planContext;
